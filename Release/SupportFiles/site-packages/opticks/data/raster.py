...
class RasterElement(types.DataElement):
   ...
   def getDataPointerArray(self, args=None):
      ...
      try:
         ...
         if nfo.interleaveFormat.value == types.InterleaveFormat.BIP:
            ar.shape = (rows, cols, bands)
         elif nfo.interleaveFormat.value == types.InterleaveFormat.BSQ:
            ar.shape = (bands, rows, cols)
         elif nfo.interleaveFormat.value == types.InterleaveFormat.BIL:
