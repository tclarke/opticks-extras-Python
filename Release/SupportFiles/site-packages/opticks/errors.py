...
paramflags = ()
getLastError = prototype(("getLastError", __api), paramflags)

prototype = CFUNCTYPE(c_char_p, c_int)
paramflags = (1, "code", ""),
getErrorString = prototype(("getErrorString", __api), paramflags)

prototype = CFUNCTYPE(c_void_p, c_int)
paramflags = (1, "code", ""),
setLastError = prototype(("setLastError", __api), paramflags)
